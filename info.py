...
BOT_TOKEN = environ.get('BOT_TOKEN', "6802684234:AAFl5yoZP0CrCnO2c601xtWPzF3h7LzmGSY")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/a52d21efa52520506e971.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/0b946f40b487542bead11.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5698613889').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002138999269') # support group id ( make sure bot is admin )
...
DATABASE_NAME = environ.get('DATABASE_NAME', "kkr")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Verify
VERIFY = bool(environ.get('VERIFY', False)) # Verification On ( True ) / Off ( False )
HOWTOVERIFY = environ.get('HOWTOVERIFY', url='https://t.me/Filmy_Rohesh/53') # How to open tutorial link for verification
